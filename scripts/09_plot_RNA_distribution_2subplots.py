...
Optimized version with improved layout:
 ...
 - Font set to Arial, and SVG output set to true vector (svg.fonttype = 'none').
"""
...
# Ensure SVG text remains vector
