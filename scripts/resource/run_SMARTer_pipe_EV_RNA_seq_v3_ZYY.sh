...
run_step "${outputDir}/2_UMI_trim" "
    ...
    cutadapt -u 14 -o ${outputDir}/2_UMI_trim/${Header}_R2_umi_trim.fq.gz ${outputDir}/2_UMI_trim/R2_umi.fq.gz

    trim_galore --phred33 --illumina --gzip --stringency 3 --cores 20 --paired --length 10 \
      ${outputDir}/2_UMI_trim/${Header}_R1_umi.fq.gz ${outputDir}/2_UMI_trim/${Header}_R2_umi_trim.fq.gz \
    ...
    multiqc ${outputDir}/2_UMI_trim   ${outputDir}/2_UMI_trim
"
...
run_step "${outputDir}/6_umi_dedup_bam" "
    ...
    python /home/yz2474/scripts/donglab/run_infer_experiment_ZYY.py ${outputDir}/6_umi_dedup_bam/${Header}_Aligned.sortedByCoord.out.bam
