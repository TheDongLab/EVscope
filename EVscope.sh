...
cutadapt -u 6 -o ${outputDir}/03_trim_galore/${SampleName}_R2_UMI_trim.fq.gz \
...
seqtk sample -s100 ${outputDir}/03_trim_galore/${SampleName}_R1_trimed.fq.gz 100000 | gzip > ${outputDir}/13_Kraken/${SampleName}_R1_downsampled.fq.gz
seqtk sample -s100 ${outputDir}/03_trim_galore/${SampleName}_R2_trimed.fq.gz 100000 | gzip > ${outputDir}/13_Kraken/${SampleName}_R2_downsampled.fq.gz
...
python /home/yz2474/scripts/donglab/EVscope/scripts/11_generate_QC_matrix.py \
    ...
    --trimmed_R1_fastq ${outputDir}/03_trim_galore/${SampleName}_R1_trimed.fq.gz \
    --trimmed_R2_fastq ${outputDir}/03_trim_galore/${SampleName}_R2_trimed.fq.gz \
...
Rscript -e \"rmarkdown::render('html_reprot.Rmd',
